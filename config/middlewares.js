module.exports = [
  ...
  },
  {
    name: 'strapi::cors',
    config: {
      origin: ['http://localhost:3000', 'http://localhost:1337', 'https://quiz-ai.azurewebsites.net', 'victorious-forest-0ec6bc610.4.azurestaticapps.net'], // specify allowed origins
